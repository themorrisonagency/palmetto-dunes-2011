<?php
namespace Concrete\Package\Calendar\Src;
use Database;
...
class Calendar
{
    ...
    public static function getList()
    {
        ...
        return $em->getRepository('\Concrete\Package\Calendar\Src\Calendar')->findBy(array(), array('caName' => 'asc'));
    }
    ...
    public static function getByID($id)
    {
        $db = Database::get();
        $em = $db->getEntityManager();
        $r = $em->find('\Concrete\Package\Calendar\Src\Calendar', $id);
        return $r;
    }
}
