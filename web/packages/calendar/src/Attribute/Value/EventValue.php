<?php
namespace Concrete\Package\Calendar\Src\Attribute\Value;

use Concrete\Package\Calendar\Src\Attribute\Key\EventKey;
use Concrete\Core\Attribute\Value\Value;
use Concrete\Package\Calendar\Src\PortlandLabs\Calendar\Event as Event;
class EventValue extends Value
{
    ...
    public static function getAttributeValueObject($event, EventKey $key, $create_on_miss = false)
    {
