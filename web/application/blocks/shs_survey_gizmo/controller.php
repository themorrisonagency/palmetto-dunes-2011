<?php
namespace Application\Block\ShsSurveyGizmo;
...
{
    protected $btTable = 'btShsSurveyGizmo';
    ...
    {
        return t("Allows you to add Survey Gizmo forms to your site.");
    }

    public function getBlockTypeName()
    {
        return t("Survey Gizmo");
    }
