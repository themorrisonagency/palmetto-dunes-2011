...
*/?>
<div class="contact-property-management">
	...
	<form enctype="multipart/form-data" class="form-stacked" id="miniSurveyView<?php  echo $bID; ?>" class="miniSurveyView" method="post" action="<?php  echo $formAction ?>">
				...
				<fieldset class="fieldGroup">
					<label class="control-label" <?php  echo $question['labelFor']; ?>>
						<?php if ($question['required']): ?>
	                        <span class="text-muted small required" style="font-weight: normal"><?=t("*")?></span>
	                    <?php  endif; ?>
        ...
        <div class="form-actions">
            ...
            <?php } ?>
			<input type="submit" name="Submit" class="btn btn-primary sg-button" value="Submit">
		</div>
...
<script>
$(function() {
	var ph = $('#miniSurveyView<?php  echo $bID; ?> label[for="Question1"]').text();
	$('#miniSurveyView<?php  echo $bID; ?> input[type="email"]').attr('placeholder', ph.trim());
