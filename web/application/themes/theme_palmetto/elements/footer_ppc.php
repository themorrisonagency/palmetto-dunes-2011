...
<div  id="header">
    <div id="header-wrapper">
        <div id="branding">
            <a href="/"><img src="/application/themes/theme_palmetto/images/logo.svg" alt="Palmetto Dunes Oceanfront Resort" border="0" width="" height=""/></a>
        </div>

        <div id="brandingtop" style="display:none;"  >
            <a href="#"><img src="/application/themes/theme_palmetto/images/logo.svg" alt="Palmetto Dunes Oceanfront Resort" border="0" width="" height=""/></a>
        </div>
        <div class="resort-num"><a href="tel:843-686-9697">843.686.9697</a></div>
    </div>
...
<div  class="footer-wrapper"><div class="footer">
    ...
    <div class="footer-cols">
            <div class="col col-1">
                <h3><a href="https://www.instagram.com/palmettodunessc/" target="_blank"><span>test Instagram &#35;Palmettodunes</span></a></h3>
            ...
            <div class="col col-2">
                ...
                <p class="phone">Phone: 843.686.9697</p>
                <p><a href="/contact-us" class="footer-link">Contact Us</a><span class="divide"> | </span>
                <a href="/hilton-head-resort-directions" class="footer-link">Maps</a></p>
            </div>
        </div>
        <div id="social-icons">
            <ul>
