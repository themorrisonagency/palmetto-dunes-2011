...
if ($c->isEditMode()) { ?>
    <div class="ccm-edit-mode-disabled-item overview-carousel" style="width: <? echo $width; ?>; height: <? echo $height; ?>">
        <div style="padding: 40px 0px 40px 0px"><? echo t('Thumbnail Slider disabled in edit mode.')?></div>
    </div>
<?  } else { ?>
    ...
    <div class="overview-carousel">
        ...
        <?php } else { ?>
            <div class="ccm-image-slider-placeholder">
                <p><?php echo t('No Images Entered.'); ?></p>
            </div>
        <?php } ?>
    </div>
<?php } ?>
