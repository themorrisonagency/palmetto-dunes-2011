...
<div class="ccm-summary-selected-item" data-page-selector="pageselectorid<%=sort%>">
	...
	<a class="ccm-sitemap-select-page" data-page-selector-launch="pageselectorid<%=sort%>" dialog-width="90%" dialog-height="70%" dialog-append-buttons="true" dialog-modal="false" dialog-title="Choose Page" href="/index.php/tools/required/sitemap_search_selector?cID=0" dialog-on-close="Concrete.event.fire('fileselectorclose', '{$fieldName}');">Select Page</a>
	<a href="javascript:void(0)" dialog-sender="pageselectorid<%=sort%>" data-page-selector-clear="pageselectorid<%=sort%>" class="ccm-sitemap-clear-selected-page" style="float: right; margin-top: -8px;display: none">
	<img src="/concrete/images/icons/remove.png" style="vertical-align: middle; margin-left: 3px"></a>
