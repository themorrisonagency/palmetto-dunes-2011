<?php
namespace Application\Block\ShsMoreToExplore;
...
class Controller extends BlockController
{
    ...
    protected $btTable = 'shsMoreToExplore';
    ...
    {
        return t("Create a masthead with left-hand page navigation.");
    }

    public function getBlockTypeName()
    {
        return t("More to Explore");
    }
