<?php
namespace Application\Block\PdWeatherUpdate;
...
class Controller extends BlockController
{
  ...
  protected $btDescription = "Weather Update Block";
  protected $btName = "WeatherUpdate";
  protected $btTable = 'btWeatherUpdate';
