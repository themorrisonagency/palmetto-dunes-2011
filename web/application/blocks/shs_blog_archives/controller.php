...
namespace Application\Block\ShsBlogArchives;
...
class Controller extends BlockController
{
    ...
    protected $btTable = 'btShsBlogArchives';

    public function getBlockTypeDescription()
    {
        return t("Provides a list of months to filter blog posts by.");
    }

    public function getBlockTypeName()
    {
        return t("Blog Archives");
    }
    ...
    public function getDateLink($dateArray = null)
    {
        ...
        if ($dateArray) {
            return \URL::page($c, 'archives', $dateArray['year'], $dateArray['month']);
        } else {
            return \URL::page($c);
        }
    }
