<?php
namespace Concrete\Package\ShsVideoMastheadSlider\Block\ShsVideoSlider;
...
class Controller extends BlockController
{
    ...
    public function duplicate($newBID) {
        ...
        while ($row = $r->FetchRow()) {
            $db->execute('INSERT INTO btShsVideoSliderEntries (bID, video, videoImage, promoTitle, promoDescription, promoButtonText, externalLinkURL, internalLinkCID, linkedFileID, sortOrder) values(?,?,?,?,?,?,?,?,?,?)',
                array(
                    $newBID,
                    $row['video'],
                    $row['videoImage'],
