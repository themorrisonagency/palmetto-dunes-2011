...
Galleria.addTheme({
    ...
    init: function(options) {
        ...
        this.bind('loadfinish', function(e) {
			...
			if(video_id)
			$('.gallery-facebook').attr('href','http://www.facebook.com/sharer.php?s=100&v=1&p[title]='+encodeURIComponent(current_title)+'&p[url]=http://youtu.be/'+video_id+'&p[images][0]='+current_media+'&p[summary]='+full_desc+' ('+current_url+')');
			else
			$('.gallery-facebook').attr('href','http://www.facebook.com/sharer.php?s=100&v=1&p[images][0]='+current_media+'&p[title]='+current_title+'&p[url]='+current_media+'&p[summary]='+full_desc);
